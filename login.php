...
<head>
    ...
    $con = new mysqli('localhost','root','','mybank');
		...
		if (isset($_POST['userLogin']))
		{
		    ...
		    {
		      $error = "<div class='alert alert-warning text-center '>Username or password wrong try again!</div>";
		    }
		}
...
<body style="background: url(images/hand.jpg);background-size: 100%">

<h1 class="alert alert-success rounded-0"></h1>
<br>
	<h1 class="text-white"> The Sparks Foundation Bank <br> Welcomes you! </h1>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	...
       	<button type="submit" class="btn btn-primary btn-block btn-sm my-1" name="userLogin">Login </button>
       </form>
      </div>
    </div>
  </div>
  <div class="card rounded-0">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	<input type="email" name="email" class="form-control" required placeholder="Enter Email" value="Manager@gmail.com">
       	<input type="password" name="password" class="form-control" required placeholder="Enter Password" value="001">
       	<button type="submit" class="btn btn-primary btn-block btn-sm my-1" name="managerLogin" >Login </button>
       </form>
      </div>
    </div>
  </div>
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        <form method="POST">
       	<input type="email"name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" class="form-control" required placeholder="Enter Password">
       	<button type="submit"  class="btn btn-primary btn-block btn-sm my-1" name="cashierLogin">Login</button>
       </form>
      </div>
    </div>
  </div>
